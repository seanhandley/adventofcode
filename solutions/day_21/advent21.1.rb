...
Player = Struct.new(:hp, :armor, :damage)
...
def fight(player1, player2)
  until(player1.hp <= 0 || player2.hp <= 0) do
    player2.hp -= [(player1.damage - player2.armor), 1].max
    break if player2.hp <= 0
    player1.hp -= [(player2.damage - player1.armor), 1].max
  end
